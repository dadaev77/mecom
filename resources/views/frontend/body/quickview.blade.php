                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            <h5 class="title-detail"><a href="shop-product-right.html" class="text-heading">Seeds of Change Organic Quinoa, Brown</a></h5>
                            <br>
                    ...
                    <span class="old-price font-md ml-15">$52</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="font-xs">
                                        <ul>
                                            <li class="mb-5">Product Code : <span class="text-brand">Nest</span></li>
